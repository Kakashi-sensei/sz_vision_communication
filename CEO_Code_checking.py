...
# Read the input CSV file with a different encoding, treating all cells as text
...
# Ensure all columns are treated as strings before saving
incorrect_coding_df = incorrect_coding_df.astype(str)
