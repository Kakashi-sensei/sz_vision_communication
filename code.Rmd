...
new_company <- read.csv(new_company_file, fileEncoding = "UTF-8", stringsAsFactors = FALSE)
old_company <- read.csv(old_company_file, fileEncoding = "UTF-8", stringsAsFactors = FALSE)

# Clean up potential invalid characters in the 'Company' column
new_company$Company <- iconv(new_company$Company, from = "UTF-8", to = "ASCII//TRANSLIT")
old_company$Company <- iconv(old_company$Company, from = "UTF-8", to = "ASCII//TRANSLIT")

# Convert the 'Company' columns to lowercase to ignore case during comparison
...
write.csv(new_company, "C:/Users/timothy/OneDrive/Documents/temp/New_nonUSA_company_updated.csv", row.names = FALSE)
