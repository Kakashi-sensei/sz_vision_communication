...
# check only in B
# Set file paths
new_company_file <- "C:/Users/timothy/OneDrive/Documents/temp/New_nonUS_company.csv"
old_company_file <- "C:/Users/timothy/OneDrive/Documents/temp/Old_nonUS_company.csv"

# Read the CSV files
new_company <- read.csv(new_company_file)
old_company <- read.csv(old_company_file)

# Add the new variable 'Only_New' to 'New_USA_company'
new_company$Only_New <- ifelse(new_company$Company %in% old_company$Company, "N", "Y")
